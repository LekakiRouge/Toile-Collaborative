...
Application web statique pour créer une grande toile collaborative par lien.
...
Puis ouvrir <http://localhost:4173>. Le serveur expose aussi l'API `GET /api/canvases/:id` et `PUT /api/canvases/:id` utilisée par le navigateur pour charger et sauvegarder la toile.
