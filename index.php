...
$syncUrls = [
    'load' => $basePath . '/load_canvas.php',
    'save' => $basePath . '/save_canvas.php',
];
...
<html lang="fr">
  <head>
    ...
    <script>
      window.TOILE_BOOTSTRAP = <?= json_encode(['canvas' => $initialCanvas, 'error' => $initialError, 'syncUrls' => $syncUrls], JSON_UNESCAPED_UNICODE | JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_AMP | JSON_HEX_QUOT) ?>;
    </script>
        ...
        <div class="workspace">
          <aside class="toolbar" aria-label="Outils de dessin">
            <fieldset>
              ...
              <button class="tool-button" type="button" data-tool="pan">Déplacer la toile</button>
            ...
            <div class="zoom-controls" aria-label="Zoom de la toile">
              <button id="zoomOutButton" type="button" class="secondary-button">−</button>
              <span id="zoomLabel">100%</span>
              <button id="zoomInButton" type="button" class="secondary-button">+</button>
              <button id="zoomResetButton" type="button" class="secondary-button">Réinitialiser</button>
            </div>
            <p class="tool-hint">Molette = zoom, outil déplacer ou espace + glisser = naviguer dans la toile infinie.</p>
